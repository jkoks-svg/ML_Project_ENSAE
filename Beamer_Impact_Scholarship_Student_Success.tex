...
\end{itemize}}
\begin{itemize}
	\item [$\Rightarrow$] All paths are blocked simultaneously by conditioning on the covariates, but NOT conditioning on the post-treatment effects. This could open collider paths through unobserved features. 
\end{itemize}
  \end{column}
